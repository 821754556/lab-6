...
public class BlackJackController implements Initializable {
	...
	private PathTransition CreatePathTransition(Point2D fromPoint, Point2D toPoint, ImageView img) {
		...
		path.getElements().add(new CubicCurveTo((toPoint.getX() +fromPoint.getX())*0.49, (toPoint.getY() +fromPoint.getY())*0.89, 
				(toPoint.getX() +fromPoint.getX())*0.89, (toPoint.getY() +fromPoint.getY())*0.44, toPoint.getX()+39, toPoint.getY()+39)); 
